        ...
        const translations = {
            vi: {
                ...
                dashboard: {
                    ...
                    table: "Bàn",
                    qrSessionBtn: "📱 QR",
                    qrSessionTitle: "Mã QR phiên bàn",
                            ...
                            data.orders.forEach((item, orderIndex) => {
                                ...
                                <div class="order-item ${isDone ? 'item-done' : ''}">
                                    <div class="item-status">
                                        <span class="status-btn ${itemStatus}" style="cursor: default;">
                                            ${statusLabel}
                                        </span>
                                    </div>
                                    <div style="flex:1">
        ...
        async function openTableSession(tableId) {
            ...
            const baseUrl = window.location.origin + window.location.pathname.replace('cashier.html', 'customer.html');
            ...
            return new Promise((resolve) => {
                ...
                const finalizeWebhookPayment = async (reason) => {
                    ...
                    try {
                        ...
                        console.log(`[QR Payment] Finalized from cashier for ${tableId} via ${reason}`);
                    } catch (error) {
                ...
                unsubscribe = db.collection('tables').doc(tableId).onSnapshot((docSnap) => {
                    ...
                    if (bankTransferDetected) {
                        console.log(`[QR Payment] Detected lastPayment for ${tableId}, finishing table reset on cashier.`);
        ...
        function switchTab(tab) {
            ...
            if (document.getElementById('menuPanel')) document.getElementById('menuPanel').style.display = tab === 'menu' ? 'block' : 'none';
            if (document.getElementById('tablePanel')) document.getElementById('tablePanel').style.display = tab === 'tables' ? 'block' : 'none';
        ...
        function updateAdminText() {
            ...
            // Optional panels for manager-like shared markup
            ...
            if (document.getElementById('tableCountLabel')) document.getElementById('tableCountLabel').innerText = t.tables.countLabel;

            // Modal
            if (document.getElementById('labelNameVi')) document.getElementById('labelNameVi').innerText = t.modal.nameLabel;
            if (document.getElementById('labelCategory')) document.getElementById('labelCategory').innerText = t.modal.categoryLabel;
            ...
            if (document.getElementById('labelAvailable')) document.getElementById('labelAvailable').innerText = t.modal.availableLabel;
